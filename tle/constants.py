...
CF_REMIND_DIV1_ROLE_ID = os.environ.get('CF_REMIND_DIV1_ROLE_ID', '')
CF_REMIND_DIV2_ROLE_ID = os.environ.get('CF_REMIND_DIV2_ROLE_ID', '')
CF_REMIND_DIV3_ROLE_ID = os.environ.get('CF_REMIND_DIV3_ROLE_ID', '')
CF_REMIND_DIV4_ROLE_ID = os.environ.get('CF_REMIND_DIV4_ROLE_ID', '')

CF_REMIND_ROLES = (
    CF_REMIND_DIV1_ROLE_ID,
    CF_REMIND_DIV2_ROLE_ID,
    CF_REMIND_DIV3_ROLE_ID,
    CF_REMIND_DIV4_ROLE_ID,
)
